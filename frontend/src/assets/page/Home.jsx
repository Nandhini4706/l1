          ...
          <div className='w-[300px] h-[300px] bg-gray-900 rounded-xl border-1 border-pink-300 '>
            <div className='flex justify-center w-[300px] h-[300px] items-center'>
              <div className='flex gap-3 flex-col'>
                ...
                <input type="age" placeholder='Age' className='w-[200px] border-1 border-pink-300 rounded-lg text-center text-white hover:bg-gradient-to-r from-pink-700 to-gray-700' />
             ...
             <button className='border-1 border-green-300 rounded-lg bg-green-800 font-medium hover:bg-blue-950 shadow-lg'>Submit</button>
              </div>
              </div>
